...
public class statisticalDataGeneratingVisitor implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    public int characterExpressionsCount = 0;
    public int integerExpressionsCount = 0;
    ...
    {
        characterExpressionsCount = characterExpressionsCount + 1;
        return null;
    }
    //********
    @Override
    ...
    {
        integerExpressionsCount = integerExpressionsCount + 1;
        return ast;
    }
